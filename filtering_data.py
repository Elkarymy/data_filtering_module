...
def main():
    ...
    intervention_type = input("Enter intervention type (e.g., Monetary incentives, Providing feedback and information...): ")
    ...
    # Filter the data
    filtered_data = filter_data(df, field_of_intervention=field_of_intervention, intervention_type=intervention_type, space_filter=space_filter_options)
